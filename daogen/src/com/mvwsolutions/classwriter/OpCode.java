...
public abstract class OpCode {
	...
	void fixStartAddress(Instruction instruction, int start, int oldPostEnd,
			int newPostEnd) {
	...
	/**
	 * Fix operands to reflect changed code positions; no op except for
	 * instructions that jump or branch
	 */
	...
	/**
	 * When a method is edited, *Switch instructions may have to end up with
	 * different operand lengths because they are supposed to be padded to a 4
	 * byte boundary. This method returns null for regular instructions; for
	 * repaddable instructions it returns a new instruction with the operands
	 * updated to reflect the correct padding.
	 */
	...
	static {
		try {
			...
			new SimpleOpCode(144, 1, "d2f", new ConvertStack(ProcessStack.CAT2,
					ProcessStack.CAT1));
			new SimpleOpCode(142, 1, "d2i", new ConvertStack(ProcessStack.CAT2,
					ProcessStack.CAT1));
			new SimpleOpCode(143, 1, "d2l", new ConvertStack(ProcessStack.CAT2,
					ProcessStack.CAT1));
			new SimpleOpCode(99, 1, "dadd", new Cat2Stack(2, 1));
			new SimpleOpCode(49, 1, "daload", new ComboStack(
					new Cat1Stack(2, 0), new Cat2Stack(0, 1)));
			new SimpleOpCode(82, 1, "dastore", new ComboStack(new Cat1Stack(2,
					0), new Cat2Stack(1, 0)));
			new SimpleOpCode(152, 1, "dcmpg", new ComboStack(
					new Cat2Stack(2, 0), new Cat1Stack(0, 1)));
			new SimpleOpCode(151, 1, "dcmpl", new ComboStack(
					new Cat2Stack(2, 0), new Cat1Stack(0, 1)));
			...
			new SimpleOpCode(141, 1, "f2d", new ConvertStack(ProcessStack.CAT1,
					ProcessStack.CAT2));
			new SimpleOpCode(139, 1, "f2i");
			new SimpleOpCode(140, 1, "f2l", new ConvertStack(ProcessStack.CAT1,
					ProcessStack.CAT2));
			...
			new SimpleOpCode(135, 1, "i2d", new ConvertStack(ProcessStack.CAT1,
					ProcessStack.CAT2));
			new SimpleOpCode(134, 1, "i2f");
			new SimpleOpCode(133, 1, "i2l", new ConvertStack(ProcessStack.CAT1,
					ProcessStack.CAT2));
			...
			new SimpleOpCode(138, 1, "l2d", new ConvertStack(ProcessStack.CAT2,
					ProcessStack.CAT2));
			new SimpleOpCode(137, 1, "l2f", new ConvertStack(ProcessStack.CAT2,
					ProcessStack.CAT1));
			new SimpleOpCode(136, 1, "l2i", new ConvertStack(ProcessStack.CAT2,
					ProcessStack.CAT1));
			new SimpleOpCode(97, 1, "ladd", new Cat2Stack(2, 1));
			new SimpleOpCode(47, 1, "laload", new ComboStack(
					new Cat1Stack(2, 0), new Cat2Stack(0, 1)));
			new SimpleOpCode(127, 1, "land", new Cat2Stack(2, 1));
			new SimpleOpCode(80, 1, "lastore", new ComboStack(new Cat1Stack(2,
					0), new Cat2Stack(1, 0)));
			new SimpleOpCode(148, 1, "lcmp", new ComboStack(
					new Cat2Stack(2, 0), new Cat1Stack(0, 1)));
			...
			new SimpleOpCode(121, 1, "lshl", new ComboStack(
					new Cat2Stack(1, 0), new ComboStack(new Cat1Stack(1, 0),
							new Cat2Stack(0, 1))));
			new SimpleOpCode(123, 1, "lshr", new ComboStack(
					new Cat2Stack(1, 0), new ComboStack(new Cat1Stack(1, 0),
							new Cat2Stack(0, 1))));
			...
			new SimpleOpCode(125, 1, "lushr", new ComboStack(
					new Cat2Stack(1, 0), new ComboStack(new Cat1Stack(1, 0),
							new Cat2Stack(0, 1))));
