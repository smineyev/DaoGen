...
import com.mvwsolutions.classwriter.Annotation;
import com.mvwsolutions.classwriter.ClassWriter;
import com.mvwsolutions.classwriter.CodeCheckException;
import com.mvwsolutions.classwriter.MethodInfo;
import com.mvwsolutions.classwriter.RuntimeInvisibleAnnotationsAttribute;
import com.mvwsolutions.classwriter.RuntimeVisibleAnnotationsAttribute;
...
//		{
			...
			if ( annotations!=null)
			{
				...
				{
					if ( cw.getString(a.getClassIndex()).endsWith("dao/meta/TableInterface;"))
					{
						result=true;
						...
						for ( MethodInfo mi : cw.getMethods())
						{
							...
							if ( methodAnnotations!=null)
							{
								...
								{
									if (cw.getString(methodAnnotation.getClassIndex()).endsWith("/dao/meta/FieldAccessor;"))
									{
						...
						java.io.PrintWriter pw=sourceBase.getWriterForClass(td.packageName+".dao", td.implementingClass);
